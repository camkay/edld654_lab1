...
panoply::perble(assessment(data_train_r10$splits[[1]])$sp_ed_fg)


sum(assessment(data_train_r10$splits[[1]])$sp_ed_fg == "Y")

sum(na.omit(assessment(data_train_r10$splits[[1]])$sp_ed_fg == "Y"))

rbind(assessment(data_train_r10$splits[[1]]),
      analysis(data_train_r10$splits[[1]])
